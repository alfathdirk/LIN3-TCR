...
staff = ["udee626454be8e869860bbcbbdb1139d0"]
...
wait = {
    ...
    'autoAdd':True,
    'message':"""THX FOR ADD : 
🐺I Wan't to promotion, for a minute 

🤖Open Admin Bot Protect :
🔹10 Bots 500k
🔹5 Bots 250k

🏄Open Staff Bot Protect :
🔸10 Bots 250k
🔸5 Bots 150k
🔸10 Bots ห้อง 5 เป็น Staff 750k
🔸5 Bots ห้อง 5 เป็น  Staff 450k

🏖บุคคลธรรมดา:
🏈10 Bots 100k  2 Groups
⚾10 Bots 85k  1 Group
🎱5 Bots 60k  2 Groups
🎳5 Bots 50k  1 Group
🎆3 Bots 35k  2 Groups
     ...
     for zx in range(0,50):
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
          try:    
            ...
            cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by : AoF!!bot\n\nhttp://line.me/ti/p/~aofbot\n\n🕛อ๊อฟคุง บริการ 24 ชม.🕛\n\n⚪รับติดตั้งแก้ไขบอทไลน์⚪")
            print "Like"
          except:
            pass
        else:
