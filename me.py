    ...
    try:
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
				...
				if msg.from_ in admin:
						cl.sendText(msg.to, "Wait boss ku..")
						try:
					...
					if msg.toType == 2:
						...
						for jj in matched_list:
							try:
								...
								pass
            elif "bersih-bersih dolo" in msg.text:
				if msg.from_ in admin:
					if msg.toType == 2:
						print "ok"
						_name = msg.text.replace("bersih-bersih dolo","")
						gs = ki.getGroup(msg.to)
						gs = kk.getGroup(msg.to)
						gs = kc.getGroup(msg.to)
						ki.sendText(msg.to,"Test Limit bentar..")
						kk.sendText(msg.to,"Lemesin aja dah gosah di lawan..")
						targets = []
						for g in gs.members:
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					bctxt = msg.text.replace("Ya boss Me..")
