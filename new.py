...
helpMessage =""" Phet BOT Menu V.2  􀔃􀄆red check mark􏿿
✴ Phet BOT Menu V.2 ✴
􀔃􀅕
✴[Bot?]     Cek Akun Bot
...
✴[Ginfo]    Group Info
✴[Phet mid]   Cek All mid Bot
✴[Phet 1/2/3/4] Cek Mid Bot
...
Bots=[mid,Amid,Bmid,Cmid,"uf66f73f5393a7eccb707f59183ce9625"]
...
#-----------------------------------------------
                ...
                kk.sendText(msg.to,"Phet 􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"Phet 􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿")
            elif msg.text in ["Phet help"]:
                ki.sendText(msg.to,"✴ Phet BOT Menu V.2 ✴
􀔃􀅕
✴[Bot?]     Cek Akun Bot
✴[Jam Update] Update jam Bot
✴[Id Group] Cek Id Group
...
#-----------------------------------------------
      ...
      #-------------Fungsi Banned Send Contact Start------------------#
            elif msg.text in ["Phetban"]:
                wait["wblacklist"] = True
                cl.sendText(msg.to,"send contact")
                ki.sendText(msg.to,"send contact")
                kk.sendText(msg.to,"send contact")
                kc.sendText(msg.to,"send contact")
            elif msg.text in ["PhetDban"]:
                wait["dblacklist"] = True
                cl.sendText(msg.to,"send contact")
                ki.sendText(msg.to,"send contact")
                kk.sendText(msg.to,"send contact")
      ...
      #-------------Fungsi Bannlist Finish------------------#  
                ...
                if msg.toType == 2:
                    ...
                    for mm in matched_list:
                        cocoa += mm + "\n"
                    cl.sendText(msg.to,cocoa + "")
            elif msg.text in ["Phet kill ban"]:
                if msg.toType == 2:
                    group = cl.getGroup(msg.to)
                    gMembMids = [contact.mid for contact in group.members]
                    matched_list = []
