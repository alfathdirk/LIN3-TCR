...
#cl = LINETCR.LINE()
#cl.login(token="ElThpLe8nLJqX3v5rHg4.+QYfC29PpiZzTdE7WAYFba.PZTDFLjI4gmikZDbByUjv0MHkCQKITYVxeadlbe0hko=")

#ki = LINETCR.LINE()
#ki.login(token="El7lojqEFKJmzcQF6UL0.93F7RfrL17jj/Dv3yf8qOa.ve1qN/Uq1/uRj9sYjzOgH1bnApzGdY/9VTiTUhvaWgc=")

#kk = LINETCR.LINE()
#kk.login(token="ElQGT9p7T02J3b5c464f.ETNpOiRL7kRYebfAcxdR+W.S1n7+LRsx2TXmUnRNW6DCg/+OGHskVul6W/RusSN41w=")

#kc = LINETCR.LINE()
#kc.login(token="El0AC1UIVHjiK8xD0595.9M9Z9tK6FSY3b+wrG86wjq.6vNlBnoSlKOmIgF+GCOyFziHpNgclpujL1aRGA1jlPo=")
...
helpMessage =""" OFF BOT Menu V.2  􀔃􀄆red check mark􏿿
✴ OFF BOT Menu V.2 ✴
􀔃􀅕
✴[Bot?]     Cek Akun Bot
...
✴[Ginfo]    Group Info
✴[OFF mid]   Cek All mid Bot
✴[OFF 1/2/3/4] Cek Mid Bot
    ...
    try:
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
                ...
                kc.sendText(msg.to,Cmid)
            elif msg.text in ["Ps1","Wkwk","Wk","wkwkwk","wkwk","wk"]:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "100",
                ...
                ki.sendMessage(msg)
                kk.sendMessage(msg)
            elif msg.text in ["Ps2","Hehe","He","hehehe","hehe","he"]:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "10",
                ...
                ki.sendMessage(msg)
                kk.sendMessage(msg)
            elif msg.text in ["Ps8","Hmm","Hm","hmmm","hmm","hm"]:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "101",
        ...
        #-------------Fungsi Jam on/off Start-------------------#            
         ...
         #-------------Fungsi Jam Update Finish-------------------#
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "Check Tukang sider : on ♪")
#-----------------------------------------------
...
#-----------------------------------------------
				...
				kc.sendText(msg.to,(bctxt))  
#-----------------------------------------------
            elif msg.text in ["ทักทาย"]:
                ki.sendText(msg.to,"Selamat datang")
                kk.sendText(msg.to,"Jangan nakal ok!")
#-----------------------------------------------
            elif msg.text in ["#OFF"]:
                ki.sendText(msg.to,"OFF 􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"OFF 􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"OFF 􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿")
                ki.sendText(msg.to,"OFF 􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"OFF 􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"OFF 􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿")
                ki.sendText(msg.to,"OFF 􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿")
                ...
                kk.sendText(msg.to,"OFF 􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"OFF 􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿")
            elif msg.text in ["OFF help"]:
                ki.sendText(msg.to,"✴ OFF BOT Menu V.2 ✴
􀔃􀅕
✴[Bot?]     Cek Akun Bot
✴[Jam Update] Update jam Bot
✴[Id Group] Cek Id Group
...
Privasi Menu V.1 􀔃􀄆red check mark􏿿
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
            elif msg.text in ["Respon","บอท","Respon Dong","respon dong"]:
                cl.sendText(msg.to,"Online, Dengan Respon Cepat")
                ki.sendText(msg.to,"Yg penting gk lemot")
                kk.sendText(msg.to,"Sama dong....")
                kc.sendText(msg.to,"เออกูยังไม่ตาย...")
      #-------------Fungsi Respon Finish---------------------#
      ...
      #-------------Fungsi Balesan Respon Finish---------------------#
       ...
       #-------------Fungsi Speedbot Start---------------------#
                ...
                start = time.time()
                cl.sendText(msg.to, "รอแปปบอทกากยิ่งกากอยู่...")
                elapsed_time = time.time() - start
                cl.sendText(msg.to, "%sseconds" % (elapsed_time))
                elapsed_time = time.time() - start
                ki.sendText(msg.to, "%sseconds" % (elapsed_time))
      ...
      #-------------Fungsi Banned Send Contact Start------------------#
            elif msg.text in ["OFFban"]:
                wait["wblacklist"] = True
                cl.sendText(msg.to,"send contact")
                ki.sendText(msg.to,"send contact")
                kk.sendText(msg.to,"send contact")
                kc.sendText(msg.to,"send contact")
            elif msg.text in ["OFFDban"]:
                wait["dblacklist"] = True
                cl.sendText(msg.to,"send contact")
                ki.sendText(msg.to,"send contact")
                kk.sendText(msg.to,"send contact")
