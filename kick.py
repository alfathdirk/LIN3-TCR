...
admin=["uaeb63e0ae0c44a241e7ad71c4bb76f75","uf3fd885a236cf2ee567e090fa628a59f","ubc52a721a8c0a50835f0a02eab6a78ba"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':False,
    'message':"Ciyee ngelock hahaha..",
    "lang":"JP",
    "comment":" Ciyee Ngeadd hahaha..",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#-------itucopyajajangandiedit------   -----------------------------------------------
            if msg.text in ["Creator"]:              
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'uaeb63e0ae0c44a241e7ad71c4bb76f75'}
                msg.contentMetadata = {'mid': 'u63832fa580d3568f6ad69867508cba82'}
                cl.sendMessage(msg)
        ...
        if op.type == 26:
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                ...
                ##cl.sendMessage(msg)
            elif msg.text in ["Buka","Link on","Urlon"]:
				if msg.from_ in admin:
					if msg.toType == 2:
						X = cl.getGroup(msg.to)
						X.preventJoinByTicket = False
...
#.acceptGroupInvitationByTicket(msg.to,Ticket)
				...
				if msg.from_ in admin:
							...
							kc.updateGroup(G)
#-----------------------------------------------
            elif msg.text in ["budak left","Budak left","budak leave","sayang leave","sayang left"]:
				if msg.from_ in admin:
					if msg.toType == 2:
						ginfo = cl.getGroup(msg.to)
						try:
					...
					if msg.toType == 2:
						...
						for jj in matched_list:
							try:
								...
								pass
            elif "모 RATA GAK RATA PENTING KIBAR 모 " in msg.text:
				if msg.from_ in admin:
					if msg.toType == 2:
						print "ok"
						_name = msg.text.replace("모 RATA GAK RATA PENTING KIBAR 모 ","")
						...
						if targets == []:
							...
							for target in targets:
								try:
									...
									ki.sendText(msg.to,"B")
            elif "~THIS IS TDR FAMS~" in msg.text:
				if msg.from_ in admin:
					if msg.toType == 2:
						print "ok"
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					ki.sendText(msg.to,"Siap Bos ♠􀨁Mē..􏿿")
#-----------------------------------------------
            elif "모 THIS IS TDR FAMS 모" in msg.text:
				if msg.from_ in admin:
					if msg.toType == 2:
						print "ok"
						_name = msg.text.replace("모 THIS IS TDR FAMS 모","")
						gs = ki.getGroup(msg.to)
						gs = kk.getGroup(msg.to)
						gs = kc.getGroup(msg.to)
						ki.sendText(msg.to,"B")
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					ki.sendText(msg.to,"Ya, Sayang ♠Mē lopiyuh..􏿿")
#--------------------------------------------
...
#-----------------------------------------------
				...
				ki.sendText(msg.to,"Owner : line.me/ti/p/~Azwieen")
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					ki.sendText(msg.to,"Selamat datang di pekok Family Room")
...
#-----------------------------------------------
            elif msg.text in ["absen dulu","Absen","absen"]:
				ki.sendText(msg.to,"Samidi On Boss Me..􏿿")
				kk.sendText(msg.to,"Ngatini On Boss Me..")
				kc.sendText(msg.to,"Suyatno On Boss Me..")
#--------------------------------------

            elif msg.text in ["Sp","Speed","speed"]:
				if msg.from_ in admin:
					start = time.time()
					cl.sendText(msg.to, "Wait boss jaringanku...")
			...
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					try:    
						...
						cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"•Auto like by Fake Store\n♠https://line.me/R/ti/p/%40pmn0318u\n\n•Support By Republic Of Gamers\n♠https://line.me/R/ti/p/%40olt0930u")
						kk.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
						kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"•Support by Republic Of Gamers\n♠https://line.me/R/ti/p/%40olt0930u\n\n•Auto Like by Fake Store\n♠https://line.me/R/ti/p/%40pmn0318u")
						print "Like"
					except:
							pass
				else:
